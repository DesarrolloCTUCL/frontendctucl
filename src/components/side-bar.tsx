        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-gray-200 bg-white px-4 py-4 dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 truncate">
              <h3 className="truncate text-sm font-medium text-gray-900 dark:text-white">John Doe</h3>
              <p className="truncate text-sm text-gray-500 dark:text-gray-400">john@acme.com</p>
            </div>
            <button
              type="button"
